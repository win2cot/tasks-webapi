...
Version 1.2 / 2026-06-02 / Issue #153 / 親 Issue #149(Sprint 0 画面設計)
...
| 不足項目が 0 件 or OpenAPI 更新の追加 Issue として起票済み | FM-G1(#354)/ FM-G2(#357)解消済み、FM-G4(#355、案 B)/ FM-G5(#356、案 B)方針確定済み。残課題は FM-G3(#358)のみ。すべて Issue 起票済み(§8) |
...
- 入力 SSOT: docs/specs/ui/screens/dashboard-task-list-task-detail-tenant-admin/decision.md (#152) / screen-flow.md §5(#150) / access-matrix.md (#151)
- API 契約: api/openapi.yaml v1.6.0
- 関連 ADR: ADR-0005(タスク認可 3 役割) / ADR-0012(楽観ロック ETag) / ADR-0014(JsonNullable for PATCH)
