...
| redirect URI | `http://localhost:*` | `https://*.dgz48.xyz` |
...
環境固有の差分(issuer URI / redirect URI 等)は **Keycloak Admin Console** または
**Keycloak Import Override** で上書きし、再 export して JSON を更新する。
