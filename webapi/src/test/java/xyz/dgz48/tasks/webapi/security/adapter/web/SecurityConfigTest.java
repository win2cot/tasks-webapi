...
class SecurityConfigTest {
  ...
  @MockitoBean ViewInvitationUseCase viewInvitationUseCase;
  @MockitoBean AcceptInvitationUseCase acceptInvitationUseCase;
  @MockitoBean RequestSignupUseCase requestSignupUseCase;
  @MockitoBean ViewSignupUseCase viewSignupUseCase;
  @MockitoBean CompleteSignupUseCase completeSignupUseCase;
